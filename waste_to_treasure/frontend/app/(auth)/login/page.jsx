  ...
  const handleSocialLogin = async provider => {
    ...
    if (provider === 'Google') {
      try {
        ...
        // No es necesario cambiar isLoading a false, la página se redirigirá.
      } catch (err) {
      ...
      setError(`Inicio de sesión con ${provider} próximamente`)
    }
  }
        ...
        <div className="space-y-3">
          ...
          >
            <svg className="w-6 h-6" viewBox="0 0 26 26" fill="none">
              <path
                d="M23.745 13.186c0-.866-.076-1.698-.22-2.496H13.28v4.72h5.877a5.023 5.023 0 01-2.179 3.298v3.066h3.527c2.065-1.902 3.26-4.702 3.26-8.022z"
                fill="#4285F4"
              />

              <path
                d="M13.28 24c2.948 0 5.422-.977 7.229-2.643l-3.527-3.066c-.977.654-2.227 1.041-3.702 1.041-2.849 0-5.26-1.925-6.123-4.51H3.489v3.16A12.001 12.001 0 0013.28 24z"
                fill="#34A853"
              />

              <path
                d="M7.157 14.822a7.22 7.22 0 010-4.644V7.018H3.489a12.001 12.001 0 000 10.965l3.668-3.161z"
                fill="#FBBC05"
              />

              <path
                d="M13.28 5.668c1.607 0 3.05.553 4.185 1.637l3.138-3.138C18.696 2.242 16.222 1 13.28 1 8.622 1 4.578 3.58 3.489 7.018l3.668 3.16c.863-2.585 3.274-4.51 6.123-4.51z"
                fill="#EA4335"
              />
            </svg>
